...
const BRANDS = [
  ...
  // ── Brand 8: Pure Earth Organics — Food & Wellness (Snacks + Wellness) ───────
  {
    ...
    products: [
      // Snacks & Sweets
      { name: 'Roasted Makhana Artisan Snack', shortDescription: 'Organic roasted lotus seeds (makhana) in three flavours, 100g resealable pouch.', fullDescription: 'Certified organic makhana roasted with cold-pressed oils. Flavours: Himalayan salt, turmeric-pepper, spiced masala. 100g per pack. Vegan, gluten-free, no preservatives. Shelf life 6 months.',
      ...
      { name: 'Organic Besan Ladoo Mithai', shortDescription: 'Small-batch organic besan ladoo, 250g tin, 10 pieces, made with desi ghee and jaggery.', fullDescription: 'Traditional recipe: organic chickpea flour (besan) roasted in pure desi ghee, sweetened with unrefined jaggery. No refined sugar, no preservatives. 250g tin, approximately 10 ladoos. Shelf life 3 weeks.',
      ...
      { name: 'Stone-Ground Dark Chocolate Bar', shortDescription: 'Stone-ground 70% cacao dark chocolate bar, 50g, single-origin Kerala beans.', fullDescription: 'Two-ingredient bar: single-origin Kerala Theobroma cacao and coconut sugar. Stone-ground 72 hours for smooth texture. 70% cacao. Vegan, dairy-free, soy-free. 50g bar.',
      ...
      { name: 'Ragi & Jaggery Cookies', shortDescription: 'Organic finger millet (ragi) and jaggery cookies, 200g, pack of 12.', fullDescription: 'Organic ragi flour, cold-pressed sesame oil, unrefined jaggery. No maida, no refined sugar. 12 cookies per pack, 200g. Vegan, gluten-free option available. Shelf life 1 month.',
      ...
      { name: 'Mixed Seeds & Nut Energy Bar', shortDescription: 'Organic energy bar with pumpkin seeds, sunflower seeds, almonds and dates, 45g.', fullDescription: 'No added sugar — sweetened only with Medjool dates. Organic pumpkin seeds, sunflower seeds, almonds, flaxseed. 45g bar. Vegan, gluten-free. 5g protein per bar. Shelf life 3 months.',
      ...
      { name: 'Spiced Roasted Cashew Mix', shortDescription: 'Organic cashews dry-roasted with Kerala spices, 200g resealable bag.', fullDescription: 'Organic W-320 cashews dry-roasted with black pepper, cumin and curry leaf — no oil, no gluten. 200g resealable bag. Vegan. Shelf life 4 months. FSSAI certified.',
      ...
      // Wellness & Superfoods
      { name: 'Raw Forest Honey', shortDescription: 'Raw unfiltered forest honey from Nilgiri hills, 500g glass jar.', fullDescription: 'Harvested from wild Nilgiri honey bees foraging on shola forest flowers. Unfiltered, unpasteurised. Contains natural pollen and propolis. 500g glass jar. FSSAI certified. Shelf life 24 months.',
      ...
      { name: 'Cold-Pressed Virgin Coconut Oil', shortDescription: 'Cold-pressed virgin coconut oil from Kerala, 500ml, no heat, no chemicals.', fullDescription: 'First-press coconut oil extracted at below 40°C from fresh-grated Kerala coconuts. No refining, bleaching or deodorising. 500ml glass bottle. Certified organic. Suitable for cooking and beauty use.',
      ...
      { name: 'Cultured Desi Cow Ghee', shortDescription: 'Bilona-churned A2 desi cow ghee, 300g glass jar, Gir cow, Saurashtra farm.', fullDescription: 'Traditional bilona method: curd set from A2 Gir cow milk, hand-churned, then slow-cooked on wood fire. 300g glass jar. No additives. FSSAI certified. Shelf life 12 months unrefrigerated.',
      ...
      { name: 'Mixed Dry Fruits & Seeds Gift Box', shortDescription: 'Curated organic dry fruit and seed gift box, 400g: almonds, walnuts, figs, pumpkin seeds.', fullDescription: 'Organic Afghan almonds, Kashmiri walnuts, Turkish figs and pumpkin seeds. No added sugar or sulfites. 400g gift box with compartments. FSSAI certified. Shelf life 6 months.',
      ...
      { name: 'Ashwagandha & Shatavari Adaptogen Blend', shortDescription: 'Certified organic ashwagandha and shatavari root powder blend, 100g, KSM-66 extract.', fullDescription: 'KSM-66 full-spectrum ashwagandha root extract blended with certified organic shatavari root powder. 100g resealable pouch. USDA Organic, FSSAI. Add to milk, smoothies or golden milk.',
  ...
  // ── Brand 9: Kochi Herb & Spice Co. — Food & Wellness (Teas + Spices) ────────
  {
    ...
    products: [
      // Teas & Infusions
      { name: 'Munnar Nilgiri First Flush Loose Leaf Tea', shortDescription: 'First flush Nilgiri black tea, 100g, estate-direct, muscatel notes.', fullDescription: 'Handpicked first flush from our Munnar estate at 1800m altitude. Bright amber liquor with muscatel and floral notes. 100g kraft pouch. Loose leaf, no staples. Rainforest Alliance certified.',
      ...
      { name: 'Kerala Masala Chai Blend', shortDescription: 'Premium Kerala masala chai spice blend, 200g, 7-spice recipe, for milk tea.', fullDescription: 'Family recipe: Assam CTC tea with freshly ground cardamom, cinnamon, ginger, black pepper, cloves, star anise and fennel. 200g resealable tin. Makes 80 cups. FSSAI certified.',
      ...
      { name: 'Tulsi & Ginger Herbal Infusion', shortDescription: 'Caffeine-free organic tulsi and ginger herbal infusion, 20 biodegradable bags.', fullDescription: 'Certified organic holy basil (tulsi) leaf and dried ginger root. No black tea, caffeine-free. 20 pyramid biodegradable bags. USDA Organic, FSSAI. Steep 5–7 min in boiling water.',
      ...
      { name: 'Organic Nilgiri Green Tea', shortDescription: 'Organic Nilgiri green tea, 100g, hand-rolled gunpowder style, sweet grassy notes.', fullDescription: 'Organic Nilgiri green tea leaves hand-rolled into tight pellets (gunpowder style). Sweet, grassy with nutty finish. 100g kraft pouch. USDA Organic, FSSAI. Steep at 75°C for 2–3 min.',
      ...
      { name: 'Darjeeling White Tea Silver Needles', shortDescription: 'First flush Darjeeling silver needle white tea, 25g, whole bud, delicate floral.', fullDescription: 'Handpicked single buds from Darjeeling gardens at 2000m. One of India\'s rarest white teas. Delicate floral and honey notes. 25g elegant glass jar. Steep at 70°C for 3–4 min.',
      ...
      { name: 'Cardamom & Rose Chai Blend', shortDescription: 'Fragrant cardamom and rose petal chai blend, 150g, with Assam base.', fullDescription: 'Assam CTC tea blended with whole green cardamom, dried rose petals, dried rose buds and a touch of saffron. 150g resealable kraft bag. Makes 60 cups. FSSAI certified.',
      ...
      // Spices & Condiments
      { name: 'Kerala Whole Spice Gift Tin', shortDescription: 'Curated Kerala whole spice tin: 6 spices, 30g each — cardamom, pepper, cloves, cinnamon, star anise, fennel.', fullDescription: 'Six resealable compartments: green cardamom (30g), Tellicherry black pepper (30g), Mysore cloves (30g), Ceylon cinnamon quills (30g), star anise (30g), fennel seeds (30g). Gift tin. FSSAI certified.',
      ...
      { name: 'Organic Turmeric Powder', shortDescription: 'Organic Lakadong turmeric powder, 200g, >5% curcumin, single-origin Meghalaya.', fullDescription: 'Lakadong variety from Meghalaya — among the world\'s highest curcumin content (>5%). Single-origin, cold-milled. 200g resealable glass jar. USDA Organic, FSSAI certified.',
      ...
      { name: 'Chettinad Spice Blend', shortDescription: 'Authentic Chettinad masala blend, 100g, hand-ground, aromatic and complex.', fullDescription: 'Traditional Chettinad recipe: 18 hand-ground spices including kalpasi, marathi mokku, star anise, kola podi and Tellicherry pepper. No salt, no fillers. 100g pouch. FSSAI certified.',
      ...
      { name: 'Kerala Raw Mango Pickle', shortDescription: 'Traditional Kerala raw mango pickle in sesame oil, 250g glass jar, spicy.', fullDescription: 'Raw Kerala Moovandan mangoes cut and pickled in cold-pressed sesame oil with mustard, chilli, fenugreek and turmeric. No preservatives, no artificial colour. 250g glass jar. Shelf life 12 months.',
      ...
      { name: 'Green Coconut Chutney Paste', shortDescription: 'Fresh-style green coconut chutney paste, 200g, refrigerate on opening.', fullDescription: 'Fresh grated coconut, green chillies, coriander, ginger and mustard — blended and packed without preservatives. 200g glass jar. Refrigerate after opening; use within 30 days. FSSAI certified.',
      ...
      { name: 'Kerala Coconut Curry Paste', shortDescription: 'Authentic Kerala coconut curry paste, 200g, roasted coconut base, 6-month shelf life.', fullDescription: 'Roasted coconut, Kerala red chillies, coriander, turmeric and tamarind blended into a paste. No water-based fillers. 200g glass jar, heat-sealed. Shelf life 6 months unrefrigerated. FSSAI certified.',
  ...
  // ── Brand 10: Mithila Art Studio — Art & Craft Objects (all 14 L3s) ──────────
  {
    ...
    products: [
      // Wall Art
      { name: 'Gond Inspired Acrylic Painting — Original', shortDescription: 'Original acrylic on canvas, Gond-inspired dots and animals, 24×36 in., signed.', fullDescription: 'Original work by Patna-based artist Priya Sahu. Acrylic on stretched canvas, Gond-inspired dot-work animals in vibrant primary colours. 24×36 in., signed and certificate of authenticity. Ready to hang.',
      ...
      { name: 'Madhubani Limited Edition Giclee Print', shortDescription: 'Limited edition giclee print of original Madhubani painting, 12×18 in., numbered and signed.', fullDescription: 'Museum-quality giclee archival print on 300gsm cotton rag paper. Reproduced from original Madhubani artwork by Meera Devi. Edition of 50, numbered and hand-signed. 12×18 in.',
      ...
      { name: 'Village Life Photography Print', shortDescription: 'Fine art archival photography print of Bihar village life, 16×20 in., cotton rag paper.', fullDescription: 'Shot on film by photojournalist Arjun Mehta in rural Bihar. Archival inkjet on 300gsm cotton rag. Open edition. 16×20 in., printed to order. Unframed, ships rolled in tube.',
      ...
      { name: 'Kantha & Ink Mixed Media Canvas', shortDescription: 'Mixed media artwork: kantha embroidery on cotton canvas over ink drawing, 18×24 in.', fullDescription: 'Original mixed media: India ink botanical drawing on cotton canvas with kantha-stitch embroidery overlay. One-of-a-kind piece. 18×24 in. Signed by artist. Ready to hang on wooden stretcher.',
      ...
      // Folk & Tribal Art
      { name: 'Original Madhubani Painting — Fish Bride', shortDescription: 'Original Madhubani painting on handmade paper, fish-bride motif, 12×18 in.', fullDescription: 'Hand-painted by Meera Devi using natural pigments on handmade paper. Traditional fish-bride (machhli dulha) motif — a favourite Madhubani narrative. 12×18 in. Signed. Certificate of authenticity.',
      ...
      { name: 'Warli Village Scene on Handmade Paper', shortDescription: 'Original Warli art scene on handmade paper, A3, tribal community motifs.', fullDescription: 'Authentic Warli tribal art from Palghar, Maharashtra. Painted in white pigment on hand-made brown khadi paper. Community dance (tarpa) scene. A3 size (29.7×42 cm). Signed. Rolled in protective tube.',
      ...
      { name: 'Gond Tree of Life Painting', shortDescription: 'Original Gond painting on canvas, tree of life with dot-work birds, 18×24 in.', fullDescription: 'Gond art from Mandla, Madhya Pradesh. Acrylic on canvas using traditional dot-and-line technique. Tree of life with peacocks and parrots. 18×24 in. Signed by artist Rupa Bai.',
      ...
      { name: 'Pattachitra Radha Krishna Scroll', shortDescription: 'Pattachitra painting of Radha-Krishna on patachitra cloth, 12×30 in., Odisha.', fullDescription: 'Authentic Odisha pattachitra on specially prepared cloth (chitru) with chalk paste base. Radha-Krishna in forest scene. Natural pigments, mineral colours. 12×30 in. Signed. Shipped rolled.',
      ...
      { name: 'Pichwai Lord Krishna with Cows', shortDescription: 'Traditional Pichwai painting on cloth, Lord Krishna with cows motif, 18×24 in.', fullDescription: 'Nathdwara-style Pichwai: intricate mineral colour painting on specially treated cotton cloth. Lord Krishna tending cows — a classic Pichwai subject. 18×24 in. Signed, authenticity certificate.',
      ...
      { name: 'Tanjore Lakshmi Gold-Leaf Panel', shortDescription: 'Tanjore painting of Goddess Lakshmi, 12×18 in., gold leaf and semi-precious stones.', fullDescription: 'Tamil Nadu Tanjore technique: gesso relief, 24k gold leaf and crushed semi-precious stones. Goddess Lakshmi with lotuses. 12×18 in. Teak frame included. Certificate of authenticity.',
      ...
      // Sculpture & Objects
      { name: 'Dokra Brass Tribal Figurine', shortDescription: 'Lost-wax dokra tribal figurine, 20 cm, woman carrying water pot, antique finish.', fullDescription: 'Lost-wax (cire perdue) cast dokra brass figurine from Bastar, Chhattisgarh. Woman with water pot on head. 20 cm tall. Antique patina finish. Each piece is unique — slight variations are authentic.',
      ...
      { name: 'Papier-Mâché Decorative Bowl', shortDescription: 'Hand-painted papier-mâché decorative bowl, 25 cm, Kashmir floral motifs, lacquer finish.', fullDescription: 'Kashmiri papier-mâché bowl hand-built from recycled paper pulp, then hand-painted with intricate floral chinar patterns. Lacquer-sealed finish. 25 cm diameter. Decorative use only.',
      ...
      { name: 'Cast Aluminium Abstract Sculpture', shortDescription: 'Cast aluminium abstract freeform sculpture, 30 cm, brushed natural finish.', fullDescription: 'Cast and hand-finished by contemporary sculptor from Bengaluru. Freeform organic shape in polished-and-brushed aluminium. 30 cm tall. 1kg. Felt base. Certificate of authenticity.',
      ...
      { name: 'Puja Bell & Incense Stand Set', shortDescription: 'Brass puja bell (ghanta) and incense stand, 2-piece ceremonial set, hand-engraved.', fullDescription: 'Solid brass puja bell with hand-engraved floral band, wooden handle. Matching incense stand with five incense holes. Traditional Hindu puja set. Bell 15 cm tall, stand 10 cm. Velvet-lined gift box.',
  ...
  // ── Brand 11: Jaipur Apparel House — Apparel & Clothing (all 23 L3s) ─────────
  {
    ...
    products: [
      // Tops
      { name: 'Sanganeri Block-Print Cotton Kurti', shortDescription: 'Hand block-printed cotton kurti, A-line, knee-length, sizes XS–3XL.', fullDescription: 'Sanganeri block-print on 180TC cotton. A-line cut, round neck, three-quarter sleeves. Side pockets. Machine washable. Sizes XS–3XL. Sold individually.',
      ...
      { name: 'Chikankari Embroidered Cotton Blouse', shortDescription: 'Hand-chikankari embroidered cotton blouse, regular fit, sizes XS–2XL.', fullDescription: 'White-on-white chikankari embroidery on 100% cotton. Regular fit with hook-and-eye back closure. Suitable as standalone top or under sheer overlay. Dry clean recommended. Sizes XS–2XL.',
      ...
      { name: 'Handwoven Khadi Men\'s Shirt', shortDescription: 'Handwoven KVIC-certified khadi cotton men\'s shirt, relaxed fit, sizes S–XXL.', fullDescription: 'Handspun handwoven khadi cotton, KVIC certified. Relaxed fit, 7-button placket, chest pocket, back yoke. Machine washable cold. Available in natural white, khaki and slate grey. Sizes S–XXL.',
      ...
      { name: 'Dabu-Print Linen Tunic', shortDescription: 'Dabu mud-resist block-print linen tunic, longline, sizes XS–2XL.', fullDescription: 'Dabu printing on 55% linen 45% cotton blend. Longline tunic (hip length), V-neck, half-sleeve, side slits. Machine wash cold. Unique crackled resist pattern on each piece. Sizes XS–2XL.',
      ...
      { name: 'Mirror-Work Embroidered Crop Top', shortDescription: 'Kutch mirror-work embroidered cotton crop top, boxy fit, sizes XS–XL.', fullDescription: 'Kutch mirror-work (shisha) embroidery on natural cotton. Boxy cropped fit, square neck, short sleeve. Pair with palazzos or skirts. Dry clean recommended. Sizes XS–XL.',
      ...
      { name: 'Kantha-Stitch Peplum Top', shortDescription: 'Hand kantha-stitched peplum top on vintage cotton, sizes XS–XL, multicolour.', fullDescription: 'Peplum silhouette cut from kantha-stitched vintage cotton. Each top is unique — slight pattern variation is a feature. Scoop neck, short sleeve. Dry clean. Sizes XS–XL.',
      ...
      // Bottoms
      { name: 'Block-Print Cotton Palazzo Pants', shortDescription: 'Hand block-printed wide-leg palazzo pants, elastic waist, sizes XS–3XL.', fullDescription: 'Sanganeri block-print on 160TC cotton. Wide-leg palazzo silhouette, elasticated waist, side pockets. Machine washable. Sizes XS–3XL. Sold individually.',
      ...
      { name: 'Handwoven Cotton Salwar Pants', shortDescription: 'Handwoven cotton salwar with drawstring waist and ankle cuffs, sizes XS–2XL.', fullDescription: 'Traditional salwar cut in handwoven 100% cotton. Drawstring waist, full taper to ankle cuffs. Deep pockets. Machine washable. Natural undyed. Sizes XS–2XL.',
      ...
      { name: 'Wide-Leg Linen-Cotton Trousers', shortDescription: 'Wide-leg linen-cotton blend trousers, elasticated smocked waist, sizes XS–2XL.', fullDescription: '55% linen 45% cotton blend. Wide-leg cut, smocked elasticated waist, side pockets. Ankle length. Machine wash cold. Sizes XS–2XL. Available in 4 neutral colours.',
      ...
      { name: 'Ajrakh-Print Cotton Midi Skirt', shortDescription: 'Ajrakh block-print cotton midi skirt, A-line with pockets, sizes XS–2XL.', fullDescription: 'Traditional ajrakh print on 180TC cotton. A-line midi length (below knee), elasticated waistband, two deep pockets. Machine wash cold. Sizes XS–2XL.',
      ...
      { name: 'Cotton Churidar Leggings', shortDescription: 'Cotton-lycra churidar leggings, ankle-length with gathered calf, sizes XS–3XL.', fullDescription: '95% cotton 5% lycra churidar leggings. Ankle-length with traditional gathered calf. Elasticated waist. Machine washable. Available in 8 solid colours. Sizes XS–3XL.',
      ...
      // Sets & Suits
      { name: 'Chikankari Cotton Salwar Suit Set', shortDescription: 'Chikankari embroidered 3-piece salwar suit set (kurta + salwar + dupatta), sizes XS–2XL.', fullDescription: 'White-on-white chikankari embroidery on muslin. 3-piece set: A-line kurta (knee-length) + straight salwar + sheer dupatta. Hook-and-eye closure. Dry clean. Sizes XS–2XL.',
      ...
      { name: 'Linen Kurta & Palazzo Co-ord Set', shortDescription: 'Linen kurta and palazzo set, 2-piece, sizes XS–2XL, minimal print.', fullDescription: '55% linen 45% cotton blend. Longline kurta (calf length) with mandarin collar + wide-leg palazzo. Indigo stripe print. Machine wash cold. Sizes XS–2XL.',
      ...
      { name: 'Block-Print Co-ord Set', shortDescription: 'Block-print co-ord set: crop top and wide-leg pants, sizes XS–XL.', fullDescription: 'Matching block-print crop top and high-waist wide-leg pants in Sanganeri floral print on cotton. Crop top with tie front. Pants with elasticated waist. Machine washable. Sizes XS–XL.',
      ...
      { name: 'Bandhani Lehenga Set (3-piece)', shortDescription: 'Bandhani tie-dye lehenga 3-piece set (lehenga + blouse + dupatta), sizes XS–L.', fullDescription: 'Traditional Rajasthani bandhani tie-dye on georgette. 3-piece: A-line lehenga + matching blouse with hook-and-eye + dupatta. Flared lehenga, fully lined. Sizes XS–L. Semi-stitched.',
      ...
      // Outerwear
      { name: 'Reversible Kantha Quilted Jacket', shortDescription: 'Reversible kantha-stitched cotton quilted jacket, sizes XS–XL, unisex.', fullDescription: 'Two-layer vintage sari cotton panels kantha-stitched together — one side floral, reverse side geometric. Zip front. Two pockets. Unisex fit. Machine wash cold. Sizes XS–XL.',
      ...
      { name: 'Merino-Pashmina Embroidered Shawl', shortDescription: 'Kashmiri-style embroidered merino-pashmina blend shawl, 28×80 in.', fullDescription: '70% merino 30% pashmina blend, lightweight yet warm. Hand needle-embroidered paisley border in silk thread — sozni style. 28×80 in. Fringe ends. Dry clean. Comes in ivory, beige, blush.',
      ...
      { name: 'Block-Print Cotton Cape', shortDescription: 'Ajrakh block-print cotton cape with hood, one size fits XS–L.', fullDescription: 'Poncho-style cape cut from ajrakh block-printed cotton. Hood with toggle. Open sides. One size fits XS–L. Machine washable. Deep teal and rust colourway.',
      ...
      { name: 'Handwoven Khadi Waistcoat', shortDescription: 'Handwoven khadi cotton 5-button waistcoat (vest), sizes S–XXL, men\'s and unisex.', fullDescription: 'KVIC-certified handwoven khadi. Classic 5-button waistcoat with welt pockets and inner lining in block-printed cotton. Sizes S–XXL. Machine wash cold. Natural undyed or slate grey.',
      ...
      // Loungewear
      { name: 'Block-Print Cotton Pyjama Set', shortDescription: 'Hand block-printed cotton pyjama set (top + bottom), sizes XS–2XL, unisex.', fullDescription: 'Soft 160TC cotton pyjama set with Sanganeri block-print. Straight-cut top with button placket + drawstring pyjama bottoms. Machine washable. Sizes XS–2XL. Unisex.',
      ...
      { name: 'Soft Modal Cotton Nightdress', shortDescription: 'Soft modal-cotton nightdress, knee-length, sizes XS–2XL, women\'s.', fullDescription: '60% modal 40% cotton. Silky-soft nightdress, scoop neck, cap sleeves, A-line knee length. Machine washable at 30°C. Available in blush, sage and sky blue. Sizes XS–2XL.',
      ...
      { name: 'Organic Cotton Yoga Set', shortDescription: 'Organic cotton yoga top and flare pants set, sizes XS–XL, women\'s.', fullDescription: 'GOTS-certified organic cotton. Racerback crop yoga top + high-waist flare pants. 4-way stretch. Machine washable. Suitable for yoga, pilates and dance. Available in 3 earth tones. Sizes XS–XL.',
      ...
      { name: 'Handloom Cotton Lounge Set', shortDescription: 'Handloom cotton loungewear set (top + pants), sizes XS–2XL, unisex.', fullDescription: 'Soft handloom cotton in two-colour stripe. Boxy top with patch pocket + straight-leg drawstring pants. Machine washable. Unisex fit. Sizes XS–2XL.',
  ...
  // ── Brand 12: Delhi Paper Studio — Stationery & Paper Goods (all 19 L3s) ─────
  {
    ...
    products: [
      // Notebooks & Journals
      { name: 'Handmade Paper Ruled Notebook A5', shortDescription: 'A5 ruled notebook, handmade cotton rag paper, 120 pages, leather cover.', fullDescription: '120 pages of 90gsm handmade cotton rag paper with light ruling. Full-grain leather cover. Elastic closure, ribbon bookmark, back pocket. A5 (14.8×21 cm). Acid-free archival paper.',
      ...
      { name: 'Dot Grid Journal with Khadi Cover', shortDescription: 'A5 dot grid journal, khadi cloth cover, 150 handmade paper pages.', fullDescription: '150 pages of 100gsm handmade cotton paper, dot grid (5mm). Khadi cloth hardcover with block-printed pattern. Lay-flat binding. Ribbon bookmark. A5 format.',
      ...
      { name: 'Block-Print Hardcover Journal A4', shortDescription: 'A4 hardcover journal with block-printed cloth, 200 pages, blank inside.', fullDescription: 'Blank 200-page journal on 80gsm offset paper. Hardcover wrapped in block-printed cotton cloth. Sewn binding lies flat. Elastic closure. A4 format (21×29.7 cm). Ideal for sketching and journaling.',
      ...
      { name: 'Handmade Paper Sketchbook A4', shortDescription: 'A4 sketchbook with 90-page 200gsm cold-press watercolour paper, spiral bound.', fullDescription: 'Spiral-bound sketchbook with 90 sheets of 200gsm cold-press watercolour handmade cotton paper. Acid-free. A4 format. Cardboard cover with block-print wrap. Suitable for pencil, ink, watercolour.',
      ...
      { name: 'Leather Travel Journal Passport Size', shortDescription: 'Compact passport-size leather travel journal, 3.5×5.5 in., refillable.', fullDescription: 'Distressed full-grain leather cover with elastic closure. Fits Midori-style traveller\'s notebook inserts. Ships with 2 inserts: 1 blank + 1 ruled, 64 pages each. Refillable. 3.5×5.5 in.',
      ...
      // Cards & Gifting
      { name: 'Handmade Paper Greeting Cards Set of 8', shortDescription: 'Set of 8 handmade paper greeting cards with envelopes, botanical designs.', fullDescription: '8 blank-inside cards on 300gsm handmade cotton rag paper. Botanical illustrations hand-block-printed in two colours. Matching cotton envelopes. Cards 4×6 in. Cellophane-free packaging.',
      ...
      { name: 'Block-Print Kraft Gift Wrapping Pack', shortDescription: 'Eco gift wrapping pack: 3 sheets block-print kraft paper + 3 twine ribbons + gift tags.', fullDescription: 'Three 70×50 cm sheets of 90gsm kraft paper hand block-printed in seasonal patterns. Three metres of natural jute twine (cut in thirds). Three handmade paper gift tags with jute strings.',
      ...
      { name: 'Block-Print Gift Box Set', shortDescription: 'Set of 3 nesting block-print gift boxes, cotton-wrap exterior, rigid board.', fullDescription: 'Three nested rigid gift boxes: 25×20×10 cm, 20×15×8 cm, 15×10×6 cm. Cotton cloth exterior in indigo block-print. Tissue paper interior. Magnetic lid closure.',
      ...
      { name: 'Handmade Paper Tags & Labels Set of 50', shortDescription: 'Set of 50 handmade paper gift tags and labels, pre-punched with jute string.', fullDescription: '50 assorted handmade cotton rag paper tags: 20 plain, 20 block-printed (botanical and geometric), 10 kraft-look. All pre-punched with 15 cm jute string. Suitable for gifts, retail, wholesale packaging.',
      ...
      { name: 'Handmade Cotton Rag Envelope Set of 25', shortDescription: 'Set of 25 handmade cotton rag envelopes, A6 size, with wax seal included.', fullDescription: '25 A6 envelopes (16×11 cm) in natural handmade cotton rag paper. Self-adhesive strip. Includes 1 sealing wax stick and brass wax seal with floral motif. Great for invitations and correspondence.',
      ...
      // Desk Accessories
      { name: 'Brass & Mango Wood Pen Holder', shortDescription: 'Handmade brass and mango wood pen holder, 3-slot, 10 cm tall.', fullDescription: 'Solid mango wood base with hand-turned brass pen tubes. Three slots for pens/pencils. 10 cm tall, 15 cm wide. Felt base. Polished brass with natural wood grain contrast.',
      ...
      { name: 'Rattan & Leather Desk Organiser', shortDescription: 'Desk organiser with 4 rattan compartments and leather label panels, 25×15×10 cm.', fullDescription: 'Natural rattan body with 4 compartments (2 small, 1 medium, 1 large for files). Leather label panel on each compartment. 25×15×10 cm. Felt base. Coordinates with pen holder and desk pad.',
      ...
      { name: 'Block-Print Linen Desk Pad', shortDescription: 'Block-print linen desk pad, 40×60 cm, with PU leather edge binding.', fullDescription: '40×60 cm work-surface desk pad. Top layer: block-printed linen. Bottom layer: cork for grip. Edge binding in PU leather with burnished corners. Wipe-clean surface. Protects desk surface.',
      ...
      { name: 'Handmade Brass Letter Opener', shortDescription: 'Hand-forged brass letter opener with mango wood handle, 22 cm.', fullDescription: 'Hand-forged and polished brass blade with turned mango wood handle. 22 cm total length, 12 cm blade. Engraved floral motif on blade. Comes in cotton pouch. Safe rounded blade tip.',
      ...
      { name: 'Hand-Painted Bookmark Set of 5', shortDescription: 'Set of 5 hand-painted handmade paper bookmarks, block-print botanical.', fullDescription: 'Five 5×18 cm bookmarks in 300gsm handmade cotton paper. Hand block-printed with botanical illustrations — each unique. Laminated for durability. Gold foil edge. Pre-punched with ribbon.',
      ...
      // Art Supplies
      { name: 'Indian Botanical Watercolour Paint Set', shortDescription: '12-colour watercolour set with natural pigments in handmade paper palette, tin case.', fullDescription: '12 half-pans of professional-grade watercolours using Indian mineral and natural pigments (turmeric, indigo, madder, saffron etc.). Handmade paper palette. Tin case with lid. 2 brushes included.',
      ...
      { name: 'Copperplate Calligraphy Starter Kit', shortDescription: 'Calligraphy starter kit: oblique pen holder, 5 nibs, 2 ink bottles, practice sheets.', fullDescription: 'Copperplate calligraphy kit: walnut oblique pen holder, 5 Nikko G nibs, black carbon ink + gold metallic ink, 20 handmade paper practice sheets with guidelines. Instruction booklet included.',
      ...
      { name: 'Beginner Block Printing Kit', shortDescription: 'Block printing starter kit: 4 pre-carved wood blocks, 3 fabric inks, 10 cotton squares.', fullDescription: '4 handmade woodblock designs (flower, leaf, geometric, elephant) + 3 fabric inks (red, blue, green) + 10 pre-washed cotton squares 30×30 cm. Complete kit to print your own fabric at home.',
      ...
      { name: 'Indian Motif Rubber Stamp Set with Ink', shortDescription: 'Set of 8 Indian motif rubber stamps (paisley, lotus, elephant etc.) with 4-colour ink pad.', fullDescription: '8 hand-carved rubber stamps mounted on mango wood: paisley, lotus, elephant, peacock, mandala, leaf, fish, geometric. 4-compartment ink pad (red, blue, black, green). Archival ink.',
  ...
  // ── Brand 13: Chennai Beauty Lab — Beauty & Ritual (all 18 L3s) ──────────────
  {
    ...
    products: [
      // Skincare
      { name: 'Kumkumadi Radiance Face Serum', shortDescription: 'Kumkumadi tailam-based face serum with saffron and sandalwood, 30ml, glass dropper.', fullDescription: 'Traditional Ayurvedic kumkumadi formulation: 27 herbs in sesame oil base including saffron, sandalwood, turmeric and lotus. 30ml dark glass dropper bottle. Paraben-free, fragrance-free. For all skin types.',
      ...
      { name: 'Neem & Turmeric Body Butter', shortDescription: 'Whipped neem and turmeric body butter, 200ml, deeply moisturising, vegan.', fullDescription: 'Whipped shea butter base with cold-pressed neem oil, organic turmeric extract and sandalwood. 200ml glass jar. Vegan, paraben-free, sulphate-free. Absorbs without greasy residue.',
      ...
      { name: 'Rose & Beeswax Lip Balm Set of 3', shortDescription: 'Set of 3 tinted lip balms in rose, berry and nude, beeswax and shea base, 10g each.', fullDescription: 'Pure beeswax and shea butter lip balms with natural pigment tints. Rose flavour with rose oxide tint. Berry with red cochineal. Nude with raw cocoa. 10g push-up tube. SPF 15.',
      ...
      { name: 'Karishalangani Eye Gel', shortDescription: 'Ayurvedic eye gel with karishalangani and aloe vera, reduces dark circles, 15ml.', fullDescription: 'Karishalangani (Eclipta alba) is a traditional Siddha herb for eye health. Combined with pure aloe vera gel and cucumber extract. 15ml airless pump. Paraben-free, fragrance-free. For all skin types.',
      ...
      { name: 'Zinc & Sandalwood Suncare Lotion SPF 50', shortDescription: 'Mineral zinc oxide sunscreen with sandalwood extract, SPF 50, 50ml, no white cast.', fullDescription: 'Nano-free 20% zinc oxide sunscreen with Mysore sandalwood extract for soothing. Water-resistant (40 min). SPF 50 PA+++. 50ml. No white cast, non-greasy. Reef-safe. FSSAI approved.',
      ...
      // Hair Care
      { name: 'Bhringraj & Amla Hair Oil', shortDescription: 'Ayurvedic bhringraj and amla hair growth oil, 100ml, sesame base, cold-infused.', fullDescription: 'Cold-infused sesame oil with bhringraj leaf, amla, brahmi, hibiscus and curry leaf. 100ml dark glass bottle. Suitable for all hair types. Paraben-free. Pre-wash scalp massage.',
      ...
      { name: 'Shikakai & Reetha Natural Shampoo Bar', shortDescription: 'Zero-waste shampoo bar with shikakai, reetha and coconut oil, 100g, sulphate-free.', fullDescription: 'Traditional Indian hair wash formulation: shikakai, reetha and amla in a cold-process soap base with coconut and castor oil. 100g bar replaces 300ml liquid shampoo. Sulphate-free, vegan, zero-waste.',
      ...
      { name: 'Hibiscus & Brahmi Conditioner', shortDescription: 'Hibiscus flower and brahmi leaf conditioner, 200ml, for frizzy and dry hair.', fullDescription: 'Hibiscus extract, brahmi leaf and argan oil in a lightweight conditioner base. For frizzy, dry and coloured hair. Silicone-free, paraben-free. 200ml pump bottle. Vegan certified.',
      ...
      { name: 'Methi & Coconut Deep Hair Mask', shortDescription: 'Deep conditioning hair mask with fenugreek (methi) and coconut milk, 200g.', fullDescription: 'Fenugreek seed powder, cold-pressed coconut milk and castor oil in a creamy hair mask. 200g glass jar. Leave-in 20–30 min before wash. For dry, damaged and chemically treated hair.',
      ...
      { name: 'Neem & Tea Tree Scalp Serum', shortDescription: 'Anti-dandruff scalp serum with neem, tea tree and salicylic acid, 50ml dropper.', fullDescription: 'Targets scalp buildup and dandruff: neem oil, tea tree essential oil, salicylic acid (1%) and panthenol. 50ml dark glass dropper. Apply to scalp between washes. Paraben-free.',
      ...
      // Aromatherapy
      { name: 'South Indian Essential Oils Discovery Set', shortDescription: 'Set of 5 pure essential oils from South India: sandalwood, vetiver, jasmine, lemongrass, patchouli.', fullDescription: 'Five 5ml dark glass bottles of GC-tested 100% pure essential oils: Mysore sandalwood, Tamil vetiver, jasmine absolute, Kerala lemongrass and Indonesian patchouli. Gift box. Shelf life 3 years.',
      ...
      { name: 'Sandalwood & Vetiver Incense Sticks Box', shortDescription: 'Handrolled natural incense sticks, sandalwood and vetiver blend, 50 sticks, 60-min burn.', fullDescription: 'Handrolled on bamboo skewers with natural wood powder, sandalwood and vetiver essential oil. No charcoal, no synthetic fragrance, no DPG. 50 sticks per box. Each stick burns 60 minutes.',
      ...
      { name: 'Jasmine & Rose Ultrasonic Diffuser Blend', shortDescription: 'Ready-to-use ultrasonic diffuser blend, jasmine and rose absolute, 100ml water-soluble.', fullDescription: 'Pre-diluted jasmine absolute and rose otto in solubiliser for use in ultrasonic diffusers. Add 10–20 drops to 100ml water. 100ml dark glass bottle. No carrier oil — no diffuser residue.',
      ...
      { name: 'Neem & Coconut Bath & Body Oil', shortDescription: 'Dry body oil with neem, coconut and turmeric, 100ml, for post-shower moisture.', fullDescription: 'Cold-pressed coconut oil and neem oil with turmeric extract and vitamin E. Absorbs quickly, non-greasy. 100ml glass spray bottle. Apply to damp skin after shower for all-day moisture.',
      ...
      // Ritual & Wellness
      { name: 'Brass Puja Thali Set', shortDescription: 'Handmade brass puja thali set with 5 pieces: plate, diya, bell, incense holder, spoon.', fullDescription: 'Solid brass puja thali (28 cm plate) with matching: oil diya, ghanta (bell), incense stick holder and puja spoon. Hand-engraved floral motifs. Brass polish included. Gift box.',
      ...
      { name: 'Singing Bowl Meditation Set', shortDescription: 'Hand-hammered 7-metal Tibetan singing bowl, 15 cm, with mallet and cushion.', fullDescription: 'Traditional 7-metal hand-hammered Tibetan singing bowl from Bodhgaya craftsmen. 15 cm diameter. Produces a rich, sustained Om tone. Includes leather-wrapped wooden mallet and embroidered silk cushion.',
      ...
      { name: 'Indian Crystal & Stone Healing Set', shortDescription: 'Set of 7 tumbled Indian crystals: rose quartz, amethyst, lapis, moonstone, tiger eye, clear quartz, black tourmaline.', fullDescription: 'Seven ethically sourced and tumbled Indian crystals, each 2–4 cm. Includes printed info card with crystal meanings. Packaged in handmade cotton drawstring pouch. Stones vary slightly in shape and colour.',
      ...
      { name: 'Sage & Neem Smudge Bundle Set of 3', shortDescription: 'Set of 3 hand-tied Indian sage and neem leaf smudge bundles, 15 cm.', fullDescription: 'Wild-harvested Indian sage (Salvia officinalis) and neem leaf bundles hand-tied with cotton twine. 15 cm each. Set of 3. Air-dry before use. Instructions for space-clearing ritual included.',
