...
const PRODUCTS = [
  {
    ...
    material: 'Soy wax, cotton wick, recycled glass', lengthCm: 7, breadthCm: 7, heightCm: 8,
  ...
  },
  {
    ...
    material: 'Cotton rope', // Dimensions vary by size — see per-variant Size attribute
    isHandmade: true, placeOfOrigin: 'Jaipur, Rajasthan', isGITagged: false,
  ...
  },
  {
    ...
    material: 'Seagrass, cotton rope', // Dimensions vary by size — see per-variant Size attribute
    isHandmade: true, placeOfOrigin: 'Jaipur, Rajasthan', isGITagged: false,
  ...
  },
  {
    ...
    material: 'Cotton', breadthCm: 35.6, lengthCm: 182.9,
  ...
  },
  {
    ...
    material: 'Cotton', lengthCm: 45.7, breadthCm: 45.7,
