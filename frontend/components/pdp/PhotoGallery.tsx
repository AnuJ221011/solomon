  ...
  if (images.length === 1) {
    return (
      <>
        ...
        >
          <Image src={images[0]} alt={productName} fill className="object-contain" priority sizes="(max-width: 1024px) 100vw, 55vw" />
        </button>
        {lightboxIndex !== null && (
      ...
      <>
        <div className="flex flex-col gap-2">
          <div className="flex gap-2 h-[220px] sm:h-[300px] md:h-[340px]">
            ...
            >
              <Image src={images[0]} alt={`${productName} — 1`} fill className="object-contain" priority sizes="(max-width: 1024px) 40vw, 22vw" />
            </button>
            <button
              type="button"
            ...
            >
              <Image src={images[1]} alt={`${productName} — 2`} fill className="object-contain" priority sizes="(max-width: 1024px) 60vw, 33vw" />
            </button>
          </div>
          ...
          {images.length === 3 && (
            ...
            >
              <Image src={images[2]} alt={`${productName} — 3`} fill className="object-contain" sizes="(max-width: 1024px) 100vw, 55vw" />
            </button>
          )}
        </div>
