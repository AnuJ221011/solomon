...
export function Footer() {
  return (
    <footer className="bg-[#1A1A1A] text-[#E8E0D8] mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-[#6B6056] leading-relaxed max-w-[220px]">
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-[#6B6056] hover:text-[#C8956C] transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 pt-6 border-t border-[#2D2D2D] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="text-xs text-[#6B6056] hover:text-[#C8956C] transition-colors">
              Privacy
            </Link>
            <Link href="/terms" className="text-xs text-[#6B6056] hover:text-[#C8956C] transition-colors">
              Terms
            </Link>
          </div>
        </div>
