        ...
        <>
          ...
          <div className="bg-[#1A1A1A] rounded-2xl p-6 text-white">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-10 w-10 rounded-xl bg-[#C8956C]/20 flex items-center justify-center">
                <Wallet className="h-5 w-5 text-[#C8956C]" />
              </div>
              <div>
                <p className="text-xs text-[#6B6056]">Available balance</p>
                <p className="font-heading text-3xl font-bold text-white">₹{balance.toFixed(0)}</p>
              </div>
            </div>
            <p className="text-xs text-[#6B6056]">Credits are applied automatically at checkout. Expire after 12 months.</p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#E8E0D8] shadow-warm overflow-hidden">
            ...
            {credits.length === 0 ? (
              <div className="py-12 text-center">
                <Clock className="h-8 w-8 text-[#E8E0D8] mx-auto mb-2" />
                <p className="text-sm text-[#6B6056]">No credits yet. Refer a brand to earn ₹500!</p>
              </div>
            ) : (
