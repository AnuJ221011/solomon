...
export default function BrandPromotionsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      {/* How it works */}
      <div className="bg-[#F5F0E8] border border-[#DDD0BA] rounded-lg p-5 text-sm text-[#444748] space-y-1">
        ...
        <div className="grid sm:grid-cols-3 gap-3 text-xs">
          {[
            ...
            <div key={title as string} className="bg-white rounded-lg p-3 border border-[#DDD0BA]">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-white rounded-lg border border-[#E5E1D8]">
          <Zap className="h-10 w-10 text-[#E5E1D8] mx-auto mb-3" />
          <p className="font-heading text-lg text-[#1A1A1A] mb-1">No promotions yet</p>
          <p className="text-sm text-[#444748] mb-4">Click ⚡ on any product in your listings to create a promotion.</p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[#E5E1D8]">
                {promotions.map((promo: any) => {
                  ...
                  return (
                    <tr key={promo.id} className="hover:bg-[#F9F7F2] transition-colors">
                      ...
                      <td className="px-4 py-3 text-[#444748] text-xs">
